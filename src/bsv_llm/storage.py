...
class StorageResult:
    ...
    metadata_txid: Optional[str] = None
        ...
        try:
            ...
            if len(payload) <= self.MAX_CHUNK_SIZE:
                ...
                return await self._store_chunked(
                    prepared_data, metadata, source_utxo, data_hash
                )
        ...
        for i, chunk in enumerate(chunks):
            ...
            try:
                ...
                return StorageResult(
                    ...
                    error=f"Failed on chunk {i+1}: {str(e)}",
                    data_hash=data_hash,
                )
