...
class BSVClient:
    ...
    async def rpc_call(self, method: str, params: list | None = None) -> Any:
        """
        ...
        response = await client.post(
            ...
            auth=(self.config.teranode.rpc_user, self.config.teranode.rpc_password),
    ...
    async def get_utxos(self, address: str | None = None) -> list[UTXOInfo]:
        """
    ...
    async def store_data(
        self, data: bytes, source_utxo: UTXOInfo, change_address: str | None = None
    ) -> str:
        """
        ...
        # Change output
        outputs.append(TransactionOutput(locking_script=P2PKH().lock(change_address), change=True))
